...
import {
  ICategorySelect,
  IProductAction,
} from "@/components/screens/editProduct/types";

const AddProduct: NextPageAuth<{ categories: ICategorySelect[] }> = ({
  categories,
}) => {
  return (
    <Meta title="Product Admin Add Page">
      <Layout>
        <EditProductPage categories={categories} variant={IProductAction.Add} />
      </Layout>
    </Meta>
  );
};
